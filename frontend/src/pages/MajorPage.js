...
export default function MajorPage() {
  ...
  if (!major) return <div className="quiz-page"><Sidebar /><div className="loading">Loading...</div></div>;

  const skills = JSON.parse(major.skills || "[]");
  const careers = JSON.parse(major.careers || "[]");
  const studyPlan = JSON.parse(major.study_plan || "[]");
        ...
        <div className="major-container">
          ...
          <div className="major-grid">
            ...
            <div className="major-box salary-box">
              ...
              <p><strong>Lebanon:</strong> {major.salary_lebanon}</p>
              <p><strong>Abroad:</strong> {major.salary_abroad}</p>
            </div>
          </div>
        </div>
      </div>
